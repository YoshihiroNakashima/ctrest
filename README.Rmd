...
**RAD-REST** (Random Encounter and Staying Time model Relying on All Detections).
...
Multiply `density` (individuals / km²) by the area of your study region in km².
...
camera traps. *Journal of Applied Ecology*, **55**(2), 735-744.
<https://doi.org/10.1111/1365-2664.13059>

Nakashima, Y., Yajima, G., & Hongo, S. (2021). Estimating animal density with
camera traps: a practitioner's guide of the REST model. *bioRxiv*.
<https://doi.org/10.1101/2021.05.18.444583>

Nakashima, Y., Yajima, G., & Matsuoka, R. (2026). Reducing data processing
effort in camera trap density estimation: Extending the REST model by
explicitly modelling animal detection processes.
*Methods in Ecology and Evolution*, **17**(3), 850-862.
